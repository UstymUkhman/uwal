...
export default class Cube
{
    ...
    /** @param {RenderPipeline} [pipeline] */
    GetPositionBufferLayout(pipeline)
    {
        ...
        !Pipeline && ThrowError(ERROR.PIPELINE_NOT_FOUND, `RenderPipeline.
            ...
            or \`Cube.SetRenderPipeline\` before getting a position buffer layout.`
        );

        return Pipeline.CreateVertexBufferLayout({ name: "position", format: "float32x3" });
    }
