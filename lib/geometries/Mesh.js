...
export default class Mesh
{
     ...
     * @param {string} [label = this.#Label]
     */
    CreateEdgeBuffer(Pipeline, indexData, label = this.#Label)
    {
        ...
        for (let i = 0, cell = 0, size = this.#PositionAttributeSize; i < length; i += size)
        {
     ...
     * @param {GPUVertexStepMode} [stepMode = "vertex"]
     */
    AddNormalBuffer(Pipeline, data, vertexEntry = "vertex", attributes = "normal", stepMode = "vertex")
    {
        this.AddVertexBuffer(Pipeline, data, attributes, vertexEntry, stepMode);
    }
     ...
     * @param {GPUVertexStepMode} [stepMode = "vertex"]
     */
    AddUVBuffer(Pipeline, data, vertexEntry = "vertex", attributes = "uv", stepMode = "vertex")
    {
        this.AddVertexBuffer(Pipeline, data, attributes, vertexEntry, stepMode);
    }
