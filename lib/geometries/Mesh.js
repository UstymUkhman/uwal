...
export default class Mesh
{
    ...
    /** @type {boolean} */ #AddNormalBuffer = false;
    ...
    /** @type {{ name: keyof Primitives, args: Object | undefined} | undefined} */ #Primitive;
    ...
    CreateBuffers(Pipeline, label = this.#Label)
    {
        ...
        let { cells, positions, normals, uvs } = /** @type {(options?: Object) => PrimitiveGeometry} */ (
        ...
        this.#AddNormalBuffer && normals && this.AddNormalBuffer(Pipeline, normals, vertexEntry);
        this.#AddUVBuffer && uvs && this.AddUVBuffer(Pipeline, uvs, vertexEntry);
    }
    ...
    /**
     * @param {keyof Primitives} name
     * @param {Object} [args]
     */
    SetPrimitive(name, args)
    {
        this.#Primitive = { name, args };
    }
