import { SetDrawParams, MathUtils } from "#/utils";
...
export default class Shape
{
    ...
    /** @typedef {import("../Constants").Segments} Segments */
     ...
     * @param {GPUVertexStepMode} [stepMode = "vertex"]
     */
    GetPositionBufferLayout(Pipeline, vertexEntry = "vertex", attributes = "position", stepMode = "vertex")
    {
        return Pipeline.CreateVertexBufferLayout(attributes, vertexEntry, stepMode);
    }
