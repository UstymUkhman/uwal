...
{
    /** @type {import("../textures/Texture").default | undefined} */ #Texture;
    ...
    async CreateBindGroupResources(Pipeline, url, requestOptions)
    {
        ...
        this.#Texture = new (await Texture());
    ...
    get BindGroupResources()
    {
        ...
        return {
            sampler: /** @type {import("../textures/Texture").default} */ (this.#Texture).CreateSampler({
