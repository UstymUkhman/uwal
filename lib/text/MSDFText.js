...
export default class MSDFText
{
    ...
    SetFont(font)
    {
        ...
        this.#CameraBuffer && /** @type {RenderPipeline} */ (this.#Pipeline).SetBindGroupFromResources(
            [...Object.values(font.BindGroupResources), this.#CameraBuffer], 0, MSDFFont.BindGroupLayout
        );
    }
    ...
    Write(string, color = 0x000000, scale = 0.01, centered = false)
    {
        ...
        if (centered)
        {
            ...
            this.#Measure(string, /** @type {MSDFFont} */ (this.#Font), ([x, y], line, index) =>
            {
            ...
            measurements = this.#Measure(string, /** @type {MSDFFont} */ (this.#Font), ([x, y], _line, c) =>
            {
                text[offset + 0] = x;
                text[offset + 1] = y;
                text[offset + 2] = c;
    ...
    set CameraMatrixBuffer(cameraBuffer)
    {
        ...
        this.#Pipeline && this.#Font && this.#Pipeline.SetBindGroupFromResources([
            ...Object.values(this.#Font.BindGroupResources), cameraBuffer
        ], 0, MSDFFont.BindGroupLayout);
    }
    ...
    Destroy()
    {
        ...
        this.#TextBindGroupLayout = undefined;
