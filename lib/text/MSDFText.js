...
export default class MSDFText
{
    ...
    Write(string, font, color = 0x000000, scale = 0.01, centered = false)
    {
        ...
        this.#Pipeline.WriteBuffer(textBuffer, this.#TextData, 0, 0, 2);
    ...
    /**
     * @todo Add method `UpdateFrom2DCamera`
     * @todo Add method `UpdateFromOrthographicCamera`
     * @param {import("../cameras").PerspectiveCamera} Camera
     */
    UpdateFromPerspectiveCamera(Camera)
    {
        !this.#Pipeline && ThrowError(ERROR.PIPELINE_NOT_FOUND, `RenderPipeline.
    ...
    SetScale(scale, textBuffer)
    {
        ...
        this.#Pipeline.WriteBuffer(textBuffer, this.#TextData, 4, 1, 1);
    }
