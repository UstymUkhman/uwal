...
export class MatcapMaterial extends FlatMaterial
{
     ...
     * @param {MatcapMaterialOptions | ShaderCode} [options]
     * @param {string} [label = "MatcapMaterial"]
     */
    constructor(Renderer, options = {}, label)
    {
        super(Renderer, options, label || "MatcapMaterial");
    }
