...
export default class UWAL
{
    ...
    {
        label: undefined, requiredFeatures: [], requiredLimits: undefined
    };
    ...
    static Destroy(buffers, textures)
    {
        ...
        UWAL.#DeviceDescriptor.requiredFeatures.splice(0);
    ...
    static async SetRequiredFeatures(features)
    {
        ...
        features.forEach(feature => adapterFeatures.has(feature)
            ? UWAL.#DeviceDescriptor.requiredFeatures.push(feature)
    ...
    static get DeviceDescriptor()
    {
        return UWAL.#DeviceDescriptor;
    }
