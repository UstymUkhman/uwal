...
export default class Camera3D extends Node
{
    ...
    UpdateWorldMatrix()
    {
        if (!this.AutoUpdateWorldMatrix) return;
        super.UpdateWorldMatrix();

        mat4.inverse(this.WorldMatrix, this.#ViewMatrix);
    ...
    LookAt(target, up = this.#Up)
    {
        ...
        mat4.multiply(this.ProjectionMatrix, this.#LookMatrix, this.#ViewProjectionMatrix);

        !this.AutoUpdateWorldMatrix && this.#UpdateFrustumPlanes();
        return this.#ViewProjectionMatrix;
    }
