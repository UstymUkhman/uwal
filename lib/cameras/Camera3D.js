...
export default class Camera3D extends Node
{
    ...
    /** @protected @type {Mat4} */ ProjectionMatrix = mat4.identity();
    ...
    GetInverseViewProjectionMatrix(translation, dst = mat4.identity())
    {
        ...
        // Optionally, reset the translation component. For example, pass
        // `vec3.zero()` as `translation` argument to get only the direction.
