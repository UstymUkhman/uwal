...
export class Camera2D extends Node2D
{
     ...
     *
     * @param {RenderPipeline} Pipeline - Pipeline that uses this camera's projection.
     */
    ...
    /**
     * @override
     * @param {Vec2} position - Camera's position in 2D space.
     */
    ...
    /**
     * @override
     * @returns {Vec3} Camera's position in 2D space.
     */
    get Position()
    {
