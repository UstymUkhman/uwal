import { WgslReflect } from "#/reflect/wgsl_reflect.module.old";
...
export default /** @abstract */ class Pipeline
{
    ...
    CreateUniformBuffer(uniformName, descriptor)
    {
        ...
        const label = `${uniformName} Uniform Buffer`, usage = USAGE.UNIFORM | (descriptor?.usage || 0);
    ...
    CreateStorageBuffer(storageName, descriptor = 1)
    {
        ...
        const usage = USAGE.STORAGE | (typeof descriptor !== "number" && descriptor.usage || 0);
