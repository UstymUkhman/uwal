...
import { WgslReflect } from "#/WGSLReflect";
...
export default /** @abstract */ class Pipeline
{
     ...
     * @property {MemberInfo[] | null} members
     *
     ...
     * @property {VariableInfo} type
     *
     * @typedef {{ [name: string]: Layout }} LayoutView
     * @typedef {TypeInfo & { isStruct: boolean }} StructInfo
     * @typedef {TypeInfo & { format?: StructInfo }} VariableInfo
