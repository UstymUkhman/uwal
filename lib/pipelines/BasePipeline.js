...
/** @abstract */ export default class BasePipeline
{
     ...
     */
    SetBindGroupsFromResources(resources, bindings = 0, layout = 0, label, dynamicOffsets)
    {
        this.SetBindGroups(this.CreateBindGroup(
     ...
     * @param {GPUBufferDynamicOffset | GPUBufferDynamicOffset[] | GPUBufferDynamicOffset[][]} [dynamicOffsets]
     */
    AddBindGroupsFromResources(resources, bindings = 0, layout = 0, label, dynamicOffsets)
    {
        this.AddBindGroups(this.CreateBindGroup(
            this.CreateBindGroupEntries(resources, bindings), layout, label
        ), dynamicOffsets);
    }
