 ...
 *
 * @exports ShaderCode, BindGroup, ShaderModuleDescriptor, BasePipelineDescriptor, BufferDescriptor
 */
...
/** @abstract */ export default class BasePipeline
{
    ...
    CreateStorageBuffer(storageName, descriptor = 1)
    {
        ...
        const byteLength = descriptor.size ?? storage.format.size * length;
