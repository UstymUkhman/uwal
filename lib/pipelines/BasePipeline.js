...
/** @abstract */ export default class BasePipeline
{
     ...
     */
    SetBindGroupsFromEntries(resources, bindings = 0, layout = 0, label, dynamicOffsets)
    {
     ...
     * @param {GPUBufferDynamicOffset | GPUBufferDynamicOffset[] | GPUBufferDynamicOffset[][]} [dynamicOffsets]
     */
    AddBindGroupsFromEntries(resources, bindings = 0, layout = 0, label, dynamicOffsets)
    {
