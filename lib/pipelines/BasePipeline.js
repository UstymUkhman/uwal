...
export default /** @abstract */ class BasePipeline
{
    ...
    /** @protected @type {string | undefined} */ Shader;
    ...
    CreateShaderModule(shader, label, sourceMap, hints)
    {
        ...
        this.Shader = (/** @type {string} */ (Array.isArray(shader) && shader.join("\n\n") || shader));
        return this.Device.createShaderModule({ label, code: this.Shader, sourceMap, compilationHints: hints });
    }
