 ...
 *     "SHAPE_MATRIX"           |
 *     "SHAPE_COLOR"            |
 *     "SHAPE_EMISSIVE_COLOR"   |
 *     "SHAPE_EMISSIVE_TEXTURE" |
 *     "SHAPE_EMISSIVE_SAMPLER" |
 *     "MESH_MATRIX"            |
 *     "MESH_COLOR"             |
 *     "MESH_EMISSIVE_COLOR"    |
 *     "MESH_EMISSIVE_TEXTURE"  |
 *     "MESH_EMISSIVE_SAMPLER"  |
 *     "AMBIENT_LIGHT"          |
 *     "DIRECTIONAL_LIGHT"      |
 *     "POINT_LIGHT"            |
 *     "SPOT_LIGHT",
...
export const BINDINGS = /*@__PURE__*/ CreateConstantObject(
{
    ...
    SHAPE_MATRIX:           20,
    SHAPE_COLOR:            21,
    SHAPE_EMISSIVE_COLOR:   22,
    SHAPE_EMISSIVE_TEXTURE: 23,
    SHAPE_EMISSIVE_SAMPLER: 24,

    MESH_MATRIX:            30,
    MESH_COLOR:             31,
    MESH_EMISSIVE_COLOR:    32,
    MESH_EMISSIVE_TEXTURE:  33,
    MESH_EMISSIVE_SAMPLER:  34,

    AMBIENT_LIGHT:          40,
    DIRECTIONAL_LIGHT:      41,
    POINT_LIGHT:            42,
    SPOT_LIGHT:             43
});
