 ...
 * @property {GPUSize64} size
 *
 * @exports RenderPipeline, RenderPipelineDescriptor, VertexAttribute, VertexBuffer, IndexBufferParams
 */
...
export default class RenderPipeline extends BasePipeline
{
    ...
    {
        if ((new Error).stack?.split("\n")[2]?.trim().split(" ")[1] !== "RenderStage.AddPipeline")
            ThrowWarning(ERROR.FORBIDDEN_METHOD_CALL, "`RenderPipeline.Init`." );
