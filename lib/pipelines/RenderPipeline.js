...
export default class RenderPipeline extends BasePipeline
{
    ...
    {
        const w = 2 / this.#Canvas.clientWidth;
        const h = -2 / this.#Canvas.clientHeight;

        mat3.set(w, 0, 0, 0, h, 0, -1, 1, 1, this.#Projection2D);
        mat4.set(w, 0, 0, 0, 0, h, 0, 0, 0, 0, 0.5 / this.#Depth, 0, -1, 1, 0.5, 1, this.#Projection3D);
    }
