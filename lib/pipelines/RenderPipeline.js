...
export default class RenderPipeline extends BasePipeline
{
    ...
    AddVertexBuffers(vertexBuffers, offsets, sizes)
    {
        ...
        return this.VertexBuffers = this.VertexBuffers.concat((Array.isArray(vertexBuffers)
            && vertexBuffers.map((buffer, b) => ({ buffer, offset: offsets[b], size: sizes[b] }))
    ...
    EncodeRenderBundle(encoder)
    {
        ...
        encoder[this.DrawMethod].apply(null, this.DrawParams);
    ...
    AddRenderBundle(encoder, drawMethod, drawParams = this.DrawParams, vertexBuffers, indexBuffer, bindGroups)
    {
        ...
        encoder[drawMethod].apply(null, /** @type {DrawParams} */ (GetParamArray(drawParams)));
