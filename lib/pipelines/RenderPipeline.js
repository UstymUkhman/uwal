...
export default class RenderPipeline extends BasePipeline
{
     ...
     */
    CreatePipeline(descriptor, useInCurrentPass)
    {
        ...
        this.Pipeline = this.Device.createRenderPipeline({ ...descriptor, vertex, fragment, label, layout });

        if (useInCurrentPass)
            this.#CurrentPass ? this.#CurrentPass.setPipeline(this.Pipeline) : ThrowWarning(ERROR.RENDER_PASS_NOT_FOUND);
    ...
    ResetPipelineState()
    {
        ...
        this.SetIndexBuffer(void 0);
        this.#MultisampleTexture = void 0;
