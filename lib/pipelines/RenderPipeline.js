...
import { GetDefaultVertexFormat, GetVertexFormatSize, DegreesToRadians } from "#/utils";
...
export default class RenderPipeline extends BasePipeline
{
    ...
    #PerspectiveProjection = mat4.identity();
     ...
     * @param {number} [aspect = this.Canvas.clientWidth / this.Canvas.clientHeight]
     */
    UpdatePerspectiveProjection(
        ...
        mat4.perspective(DegreesToRadians(fov), aspect, near, far, this.#PerspectiveProjection);
