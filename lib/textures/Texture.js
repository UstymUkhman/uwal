...
export default class Texture
{
    ...
    GenerateCubeMipmaps(texture)
    {
        ...
        if (!this.#MipmapsModule || !this.#MipmapsSampler)
        {
            ...
            this.#MipmapsSampler = this.CreateSampler({ minFilter: FILTER.LINEAR, magFilter: FILTER.LINEAR });
        }
         ...
         * @type {import("../pipelines/RenderPipeline").IndexBufferParams | IndexBufferParamsValues}
         */

        // Save current render pipeline state:
        let indexBuffer = this.#Renderer.IndexBuffer;
        ...
        indexBuffer &&= /** @type {[GPUBuffer, GPUIndexFormat, GPUSize64, GPUSize64]} */ (Object.values(indexBuffer));
        ...
        // Restore saved render pipeline state:
        ...
        this.#Renderer.UseCurrentTextureView = useCurrentTextureView; // @ts-ignore
        this.#Renderer.SetIndexBuffer(...(Array.isArray(indexBuffer) && indexBuffer || [undefined]));
    }
