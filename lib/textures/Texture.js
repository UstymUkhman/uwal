...
export class Texture
{
     ...
     * optional properties: `addressModeUV` for width and height; `addressMode` is for all 3 dimensions;
     * `minMagFilter` for min and mag, and `filter` for min, mag and `mipmapFilter`.
     */
     ...
     * and [Renderer.CanvasSize](./Renderer#canvassize) respectively.
     */
