...
export default class Texture
{
    ...
    {
        const { mipLevelCount: mipLevel, mipmaps = true, size: dimensions } = options;
        const mipLevelCount = mipLevel ?? ((mipmaps && this.GetMipmapLevels(source)) || void 0);
    ...
    /**
     * @deprecated Pass `RenderPipeline` instance to the `Texture` constructor or use `Texture.Renderer` setter instead.
     * @param {Renderer} renderer
     */
