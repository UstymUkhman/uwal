...
export default class Texture
{
    ...
    CopyImageToTexture(source, options = { create: true })
    {
        ...
        const { flipY, mipLevel, aspect, colorSpace, premultipliedAlpha, generateMipmaps } = options;

        // When `generateMipmaps` option is explicitly set to `false`, `mipmaps` option in the `create` configuration
        ...
        if (generateMipmaps === false) (create = typeof create === "object" && create || {}).mipmaps ??= false;
