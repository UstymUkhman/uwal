...
/**
 * @typedef {"GREATER_EQUAL" | "LESS_EQUAL" | "NOT_EQUAL" | "GREATER" | "ALWAYS" | "NEVER" | "EQUAL" | "LESS"} Keys
 * @typedef {"greater-equal" | "less-equal" | "not-equal" | "greater" | "always" | "never" | "equal" | "less"} Values
 * @type {Readonly<Record<Keys, Values>>}
 */
