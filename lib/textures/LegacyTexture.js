...
export default class LegacyTexture
{
    ...
    {
        !this.#Renderer && ThrowError(ERROR.LEGACY_RENDER_PIPELINE_NOT_FOUND, "creating a texture with mipmaps.");
    ...
    {
        !this.#Renderer && ThrowError(ERROR.LEGACY_RENDER_PIPELINE_NOT_FOUND, "creating a multisample texture.");
    ...
    CopyTextureToTexture(options)
    {
        ...
        !this.#Renderer && ThrowError(ERROR.LEGACY_RENDER_PIPELINE_NOT_FOUND, "copying a texture to a texture.");
    ...
    CopyTextureToBuffer(options)
    {
        ...
        !this.#Renderer && ThrowError(ERROR.LEGACY_RENDER_PIPELINE_NOT_FOUND, "copying a texture to a buffer.");
    ...
    CopyBufferToTexture(options)
    {
        ...
        !this.#Renderer && ThrowError(ERROR.LEGACY_RENDER_PIPELINE_NOT_FOUND, "copying a buffer to a texture.");
