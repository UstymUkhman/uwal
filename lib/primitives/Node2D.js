...
export default class Node2D
{
    ...
    ResetLocalMatrix()
    {
        this.#LocalMatrix = mat3.identity();
    }
    ...
    #UpdateLocalMatrix()
    {
        ...
        for (let t = 0, tl = transformations.length; t < tl; t++)
            ...
            {
                case "T":
                    mat3.translation(this.#Position, this.#LocalMatrix);
                break;
    ...
    {
        mat3.translate(this.#LocalMatrix, translation, this.#LocalMatrix);
    }
    ...
    set Position(position)
    {
        ...
        mat3.translation(position, this.#LocalMatrix);
    }
