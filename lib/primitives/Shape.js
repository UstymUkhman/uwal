...
import ShapeMaterial from "#/materials/Shape";
...
export default class Shape
{
     ...
     * @param {Material} [material = ShapeMaterial]
     * @param {string} [label = "Shape"]
     */
    constructor(geometry, material = new ShapeMaterial(), label = "Shape")
    {
    ...
    #CreateProjectionBuffer(resolutionBuffer, descriptor)
    {
        ...
        this.#Projection = mat3.identity(projection); this.#ProjectionBuffer = buffer;
