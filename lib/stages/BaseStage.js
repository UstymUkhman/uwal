...
/** @abstract */ export default class BaseStage
{
    ...
    /**
     * @description Utility method for `GPUDevice.createBuffer`. Its use here should be avoided, preferring the same
     * method on pipeline level whenever possible, as it would return the same result.
     * @param {GPUBufferDescriptor} descriptor
     */
    CreateBuffer(descriptor)
    {
        const label = descriptor.label ?? this.CreateStageLabel("Buffer");
