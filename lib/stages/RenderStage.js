...
export default class RenderStage extends BaseStage
{
    ...
    #RenderScene(Scene, submit = true)
    {
        ...
        const { ProjectionMatrix, ViewProjectionMatrix } =
            /** @type {import("../cameras").PerspectiveCamera} */ (Scene.MainCamera);
        ...
        Scene.Traverse(node =>
        {
            ...
            // Skip meshes outside the camera frustum / view:
            // if (!Camera.Contains(/** @type {Shape} */ (mesh))) return true;
