...
import
{
    ERROR as PRIMITIVE_ERROR,
    ERROR_MESSAGE as PRIMITIVE_ERROR_MESSAGE
}
from "#/primitives/Errors";

import
{
    ERROR as GEOMETRY_ERROR,
    ERROR_MESSAGE as GEOMETRY_ERROR_MESSAGE
}
...
/**
 * @typedef {keyof typeof import("./pipelines/Errors").ERROR_CAUSE} PipelineErrorCause
 * @typedef {keyof typeof import("./stages/Errors").ERROR_CAUSE} StageErrorCause
 *
 ...
 * } ErrorCause
 *
 * @type {Readonly<Record<PipelineErrorCause | StageErrorCause | ErrorCause, number>>}
 */
