 ...
 * [Type Aliases](#type-aliases) are [namespaces](https://wgpu-matrix.org/docs/modules.html) and
 * [utils](https://wgpu-matrix.org/docs/modules/utils.html) re-exported from [wgpu-matrix](https://github.com/greggman/wgpu-matrix),
 * so their original documentation is completely relevant for this module.
 */
