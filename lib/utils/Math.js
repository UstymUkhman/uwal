/**
 * @module MathUtils
 * @description A set of mathematical variables and functions for general-purpose usage.
 */
 ...
 *
 * @param {number} [min = 1] - Lower or upper limit.
 ...
 * When `max` is omitted, it defaults to `min` while `min = 0`.
 *
 * @param {number} min - Lower or upper limit.
 * @param {number} [max] - Upper limit.
 */
 ...
 * @throws `ERROR.INVALID_ROTATION_ORDER` if the `order` argument is not valid.
 *
 * @param {import("wgpu-matrix").Mat4} src - Matrix to get the rotation from.
 ...
 *
 * @param {import("wgpu-matrix").Mat4} src - Matrix to get the scale from.
 */
export function GetMaxAxisScale(src)
{
