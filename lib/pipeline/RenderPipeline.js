...
export default class RenderPipeline extends BasePipeline
{
    ...
    Render(descriptor, pipeline, params, submit = true)
    {
        if (!this.#CurrentPass)
        {
            ...
            this.#CurrentPassDraw = this.#CurrentPass.draw.bind(this.#CurrentPass);
        ...
        if (this.#IndexBuffer)
        {
            this.#CurrentPassDraw ??= this.#CurrentPass.drawIndexed.bind(this.#CurrentPass);

            this.#CurrentPass.setIndexBuffer(
