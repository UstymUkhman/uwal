...
export default class BasePipeline
{
     ...
     */
    CopyBufferToBuffer(encoder, source, destination, size, sourceOffset = 0, destinationOffset = 0)
    {
    ...
    {
        return this.Device.createCommandEncoder({ label: this.#CommandEncoderLabel });
    }

    /** @param {GPUCommandEncoder} encoder */
    SubmitCommandBuffer(encoder)
    {
