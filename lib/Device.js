 ...
 * {@link TextureUtils} helpers and {@link GPUQuerySet}s. It can require a {@link GPUAdapter} and a {@link GPUDevice}
...
export class Device
{
     ...
     * Must be set **before** calling `UWAL.Renderer`, `UWAL.Computation`, `UWAL.TextureUtils` or `UWAL.CreateQuerySet`.
