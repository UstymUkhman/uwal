...
export class Device
{
     ...
     * @see [GPUTiming](https://github.com/UstymUkhman/uwal/blob/main/lib/utils/GPUTiming.js) which uses a `"timestamp"` query set.
     ...
     * @returns {GPUTextureFormat} Only possible formats are `"rgba8unorm"` and `"bgra8unorm"`.
     */
