 ...
 * @typedef {Pick<Partial<CanvasConfiguration>, "format"> &
...
export default class Device
{
    ...
    static Destroy(buffers, textures)
    {
        ...
        this.ForceFallbackAdapter = !!(this.PowerPreference = undefined);
    }
    ...
    /** @param {GPUPowerPreference | undefined} powerPreference */
